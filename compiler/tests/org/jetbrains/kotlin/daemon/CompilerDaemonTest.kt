...
public class CompilerDaemonTest : KotlinIntegrationTestBase() {
    ...
    private fun compileOnDaemon(compilerId: CompilerId, daemonJVMOptions: DaemonJVMOptions, daemonOptions: DaemonOptions, vararg args: String): CompilerResults {
        ...
        val code = KotlinCompilerClient.compile(daemon!!, CompileService.CompilerImplementation.JVM, args, strm)
    ...
    public fun testDaemonTransitiveRun() {
        ...
        try {
            ...
            // testing that running daemon in the child process doesn't block on process.waitFor()
            ...
            TestCase.assertFalse("process.waitFor() hangs", waitThread.isAlive)

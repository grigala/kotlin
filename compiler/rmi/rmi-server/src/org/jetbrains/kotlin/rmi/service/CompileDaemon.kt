    ...
    public fun main(args: Array<String>) {
        ...
        try {
            ...
            val compilerSelector = object : CompilerSelector {
                ...
                override fun get(flavor: CompileService.CompilerImplementation): CLICompiler<*> = when (flavor) {
                    CompileService.CompilerImplementation.JVM -> jvm
                    CompileService.CompilerImplementation.JS -> js
                }
            }

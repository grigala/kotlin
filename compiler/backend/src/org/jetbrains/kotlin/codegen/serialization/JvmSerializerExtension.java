...
public class JvmSerializerExtension extends SerializerExtension {
    ...
    @Override
    public void serializeProperty(@NotNull PropertyDescriptor property, @NotNull ProtoBuf.Property.Builder proto) {
        SignatureSerializer signatureSerializer = new SignatureSerializer();
        ...
        if (property instanceof DeserializedPropertyDescriptor) {
            DeserializedPropertyDescriptor deserializedCallable = (DeserializedPropertyDescriptor) property;

...
public class ExpressionCodegen extends JetVisitor<StackValue, StackValue> implements LocalLookup {
        ...
        return StackValue.operation(type, new Function1<InstructionAdapter, Unit>() {
            ...
            public Unit invoke(InstructionAdapter v) {
                ...
                if (superCall != null) {
                    ...
                    argumentGenerator.generate(valueArguments, valueArguments, ExpressionCodegen.this);
                }
    ...
    public void invokeMethodWithArguments(
        ...
        List<Integer> masks =
                argumentGenerator.generate(valueArguments, new ArrayList<ResolvedValueArgument>(resolvedCall.getValueArguments().values()), this)
                        .toInts();
